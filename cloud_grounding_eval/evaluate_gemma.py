...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dataset", type=Path, required=True, help="Input validated dataset JSONL")
    parser.add_argument("--few-shot", type=Path, required=True, help="Predicate-specific few-shot JSON")
    parser.add_argument("--errors", type=Path, required=True, help="Output JSONL for failed predictions")
    parser.add_argument("--log-file", type=Path, required=True, help="Output evaluation log")
