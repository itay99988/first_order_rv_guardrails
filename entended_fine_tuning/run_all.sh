...
#
# Required env (or use the flags below):
#   HF_TOKEN  - Hugging Face token for gated repos (Llama, Mistral, Gemma)
#
# Optional env:
#   DATASET     (default: test.dataset.validated.jsonl)
#   FEW_SHOT    (default: test.few_shot_examples.json)
#   OUTPUT_BASE (default: output)
#   PORT        (default: 8000)
#   VENV_DIR    (default: vllm_env)
#   READY_TIMEOUT_SEC (default: 900) - how long to wait for the server
#   MODELS      - space-separated override list of model ids
...
FEW_SHOT="${FEW_SHOT:-test.few_shot_examples.json}"
