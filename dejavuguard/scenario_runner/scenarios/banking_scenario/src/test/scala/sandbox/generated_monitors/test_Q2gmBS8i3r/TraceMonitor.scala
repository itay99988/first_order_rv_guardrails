  ...
  def main(args: Array[String]): Unit = {
    ...
    if (2 <= args.length && args.length <= 10 && args.length % 2 == 0) {
      ...
      Options.RESULT_FILE = resultfile match {
        case Some(value) => value.toString
        case None => "/Users/moraneus/Downloads/dejavu/LLMrv/dejavuguard/scenario_runner/scenarios/banking_scenario/./src/test/scala/sandbox/generated_monitors/test_Q2gmBS8i3r/dejavu-results"
      }
