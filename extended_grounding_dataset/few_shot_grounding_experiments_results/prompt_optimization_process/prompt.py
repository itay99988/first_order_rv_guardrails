...
- The message asks a yes/no question about whether the predicate applies ("Was X employed by Y?", "Did X do Y?", "Can you confirm if X?")
- The message queries availability or existence ("Are there flights from X to Y?", "Is X available?")
- The predicate action is historical, conditional, or hypothetical ("Last year X was with Y", "if X were to...")
...
- The message looks for or wants to find something, rather than actually requesting or providing it
...
- mention = exact substring copied from the message
